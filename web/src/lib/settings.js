...
export default {
  ...
  vkServiseSubscriptions: process.env.REACT_APP_VK_SERVISE_SUBSCRIPTIONS,

  instaServise: process.env.REACT_APP_INSTA_SERVISE,

  uriAuthServisePublic: `${process.env.REACT_APP_AUTH_SERVISE}/v2/public`,
  uriAuthServisePrivate: `${process.env.REACT_APP_AUTH_SERVISE}/v2/private`,
